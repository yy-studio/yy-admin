package com.yystudio.admin.interceptor;
...
import com.yystudio.base.common.domain.SystemEnvironment;
...
public class AppInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        try {
            ...
            RequestAppUser requestAppUser = appUserLoginService.getLoginAppUser(loginId, request);
