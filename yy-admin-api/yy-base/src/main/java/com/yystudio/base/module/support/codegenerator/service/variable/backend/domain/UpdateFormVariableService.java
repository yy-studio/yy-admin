package com.yystudio.base.module.support.codegenerator.service.variable.backend.domain;
...
import com.yystudio.base.module.support.codegenerator.domain.model.CodeInsertAndUpdate;
import com.yystudio.base.module.support.codegenerator.domain.model.CodeInsertAndUpdateField;
    ...
    public ImmutablePair<List<String>, List<Map<String, Object>>> getPackageListAndFields(List<CodeInsertAndUpdateField> fields, CodeGeneratorConfigForm form) {
        ...
        for (CodeInsertAndUpdateField field : fields) {
            ...
            if (SmartStringUtil.isNotEmpty(codeField.getEnumName())) {
                packageList.add("import com.yystudio.base.common.swagger.SchemaEnum;");
                packageList.add("import com.yystudio.base.common.validator.enumeration.CheckEnum;");
            ...
            if (SmartStringUtil.isNotEmpty(codeField.getDict())) {
                ...
                packageList.add("import com.yystudio.base.common.json.deserializer.DictValueVoDeserializer;");
            }
            ...
            if (SmartStringUtil.contains(field.getFrontComponent(), "Upload")) {
                ...
                packageList.add("import com.fasterxml.jackson.databind.annotation.JsonDeserialize;");
                packageList.add("import com.yystudio.base.common.json.deserializer.FileKeyVoDeserializer;");
            }
