...
import com.yystudio.base.module.support.operatelog.OperateLogDao;
...
public abstract class OperateLogAspect {
    ...
    private static final String POINT_CUT = "@within(com.yystudio.base.module.support.operatelog.annotation.OperateLog) || @annotation(com.yystudio.base.module.support.operatelog.annotation.OperateLog)";
