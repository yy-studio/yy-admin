...
import com.yystudio.base.common.swagger.SmartOperationCustomizer;
...
//    @Value("${springdoc.swagger-ui.server-base-url:''}")
    ...
    public OpenAPI api() {
        return new OpenAPI()
                ...
                .info(new Info()
                        .title("YyAdmin 3.X 接口文档")
                        .contact(new Contact().name("yy-studio").email("lab1024@163.com").url("https://1024lab.net"))
                        .version("v3.X")
