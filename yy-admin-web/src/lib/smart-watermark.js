...
let yyAdminWaterMarkIntervalId = null;
...
const watermark = {
    ...
    set: function (id, str) {
        ...
        //每隔1分钟检查一次水印
        yyAdminWaterMarkIntervalId = setInterval(() => {
            setWatermark(id, str);
        }, 60000);
    ...
    clear: function () {
        ...
        if (yyAdminWaterMarkIntervalId) {
            clearInterval(yyAdminWaterMarkIntervalId);
            yyAdminWaterMarkIntervalId = null;
        }
    },
};
