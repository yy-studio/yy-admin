      ...
      <div class="welcome">
        ...
        <p class="desc">
          ...
          <a target="_blank" href=""
            style="color: white; weight: bolder; font-size: 15px; text-decoration: underline">yy-studio</a>
...
onMounted(() => {
  ...
  notification['success']({
    message: '温馨提示',
    description: 'YyAdmin 提供 9种 登录背景风格哦！',
    duration: 8,
    onClick: () => { },
    btn: () =>
      h(
        Button,
        {
          ...
          target: '_blank',
          size: 'small',
          href: 'https://yyadmin.vip/views/v3/front/Login.html',
          onClick: () => { },
        },
        { default: () => '去看看' }
      ),
