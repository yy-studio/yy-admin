    ...
    <view class="uni-flex"
      ...
      <view class="top">
        ...
        <view class="login-input username-view">
          <input class="uni-input " focus placeholder="昵称" :placeholder-style="placeholderStyle"
            v-model="loginForm.username" />
        </view>
        <view class="login-input mobile-view">
          <input class="uni-input " placeholder="手机号/邮箱" :placeholder-style="placeholderStyle"
            v-model="loginForm.loginName" />
        </view>
        <view class="login-input password-view">
          <input class="uni-input" placeholder="密码" :password="showPassword" :placeholder-style="placeholderStyle"
            v-model="loginForm.password" />
          <uni-icons class="content-clear-icon" :type="showPassword ? 'eye-filled' : 'eye-slash-filled'" :size="22"
            color="#808080" @click="showPasswordEye"></uni-icons>
        </view>
...
async function register() {
  ...
  try {
    ...
    uni.showToast({
      title: registerType.value == 1 ? '注册成功，请验证手机号' : '注册成功，请验证邮箱',
      position: 'bottom',
    });
